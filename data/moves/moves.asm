...
Moves1:
	...
	move EFFECT_TRAP_TARGET,        15, FIRE,     STATUS, 70, 15,   0 ;FIRE_SPIN
	...
	move EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC,  PHYSICAL,100, 10,  10 ;PSYCHIC_M
	...
	move EFFECT_RECOIL_HIT,         50, NORMAL,   STATUS,100,  1,   0 ;STRUGGLE
	...
	move EFFECT_SNORE,              40, NORMAL,   STATUS,100, 15,  30 ;SNORE
	...
	move EFFECT_MIRROR_COAT,         1, PSYCHIC,  STATUS,100, 20,   0 ;MIRROR_COAT
	...
	move EFFECT_FUTURE_SIGHT,       80, PSYCHIC,   STATUS,90, 15,   0 ;FUTURE_SIGHT
	move EFFECT_DEFENSE_DOWN_HIT,   20, FIGHTING, PHYSICAL,100, 15,  50 ;ROCK_SMASH
	move EFFECT_TRAP_TARGET,        15, WATER,     STATUS,70, 15,   0 ;WHIRLPOOL
