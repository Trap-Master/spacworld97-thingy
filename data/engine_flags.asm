...
; entries correspond to ENGINE_* constants
	...
	engine_flag wVisitedSpawns, SPAWN_SHIZUOKA
	engine_flag wVisitedSpawns, SPAWN_KYOTO
	engine_flag wVisitedSpawns, SPAWN_OSAKA
	engine_flag wVisitedSpawns, SPAWN_KOCHI
	engine_flag wVisitedSpawns, SPAWN_TOTTORI
	engine_flag wVisitedSpawns, SPAWN_HIROSHIMA
	engine_flag wVisitedSpawns, SPAWN_KITAKYUSHU
	engine_flag wVisitedSpawns, SPAWN_NIIGATA
	engine_flag wVisitedSpawns, SPAWN_SADO
	engine_flag wVisitedSpawns, SPAWN_AOMORI
	engine_flag wVisitedSpawns, SPAWN_HAKODATE
	engine_flag wVisitedSpawns, SPAWN_SENDAI
	engine_flag wVisitedSpawns, SPAWN_TOKYO
	engine_flag wVisitedSpawns, SPAWN_FUJI
	engine_flag wVisitedSpawns, SPAWN_NIHON_LEAGUE
