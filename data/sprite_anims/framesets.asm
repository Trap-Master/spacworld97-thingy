...
.Frameset_MagnetTrainPurple:
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_PURPLE_1,  8
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_PURPLE_2,  8
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_PURPLE_1,  8
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_PURPLE_2,  8, OAM_X_FLIP
	dorestart
