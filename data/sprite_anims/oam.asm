...
; entries correspond to SPRITE_ANIM_OAMSET_* constants
	...
	dbw $00, .OAMData_MagnetTrainPurple          ; SPRITE_ANIM_OAMSET_MAGNET_TRAIN_RED_1
	dbw $04, .OAMData_MagnetTrainPurple          ; SPRITE_ANIM_OAMSET_MAGNET_TRAIN_RED_2
	...
	dbw $00, .OAMData_PurpleWalk                 ; SPRITE_ANIM_OAMSET_BLUE_WALK_1
	dbw $04, .OAMData_PurpleWalk                 ; SPRITE_ANIM_OAMSET_BLUE_WALK_2
...
.OAMData_Leaf:
	db 1
	dsprite -1,  4, -1,  4, $00, PAL_OW_GREEN
...
.OAMData_CutTree2:
	db 4
	dsprite -1,  0, -2,  6, $00, PAL_OW_GREEN
	dsprite -1,  0,  0,  2, $01, PAL_OW_GREEN
	dsprite  0,  0, -2,  6, $02, PAL_OW_GREEN
	dsprite  0,  0,  0,  2, $03, PAL_OW_GREEN

.OAMData_CutTree3:
	db 4
	dsprite -1,  0, -2,  4, $00, PAL_OW_GREEN
	dsprite -1,  0,  0,  4, $01, PAL_OW_GREEN
	dsprite  0,  0, -2,  4, $02, PAL_OW_GREEN
	dsprite  0,  0,  0,  4, $03, PAL_OW_GREEN

.OAMData_CutTree4:
	db 4
	dsprite -1,  0, -2,  0, $00, PAL_OW_GREEN
	dsprite -1,  0,  1,  0, $01, PAL_OW_GREEN
	dsprite  0,  0, -2,  0, $02, PAL_OW_GREEN
	dsprite  0,  0,  1,  0, $03, PAL_OW_GREEN
