...
; wShizuokaSceneID
	const_def
	const SCENE_SHIZUOKA_STUMP              ; 0
	const SCENE_SHIZUOKA_CHRIS              ; 1
	const SCENE_SHIZUOKA_NOTHING   ; 2
	;const SCENE_STUMP_FIGHT ; 2
	
; wStumpsLabSceneID
	const_def
	const SCENE_STUMPSLAB_NOTHING              ; 0
	const SCENE_STUMPSLAB_STARTER         ; 1
...
;wPalletTownSceneID
	const_def 1
	const SCENE_PALLET_NOTHING ; 1
	const SCENE_PALLET_STOP ;2
...
; wViridianSceneID
	const_def
	const SCENE_VIRIDIAN_NOTHING ;1
	const SCENE_MEET_JENNY   ; 2
	const SCENE_MEET_ROCKETS ; 3
