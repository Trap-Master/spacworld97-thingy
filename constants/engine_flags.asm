...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_SHIZUOKA
	const ENGINE_FLYPOINT_KYOTO
	const ENGINE_FLYPOINT_OSAKA
	const ENGINE_FLYPOINT_KOCHI
	const ENGINE_FLYPOINT_TOTTORI
	const ENGINE_FLYPOINT_HIROSHIMA
	const ENGINE_FLYPOINT_KITAKYUSHU
	const ENGINE_FLYPOINT_NIIGATA
	const ENGINE_FLYPOINT_SADO
	const ENGINE_FLYPOINT_AOMORI
	const ENGINE_FLYPOINT_HAKODATE
	const ENGINE_FLYPOINT_SENDAI
	const ENGINE_FLYPOINT_TOKYO
	const ENGINE_FLYPOINT_FUJI
	const ENGINE_FLYPOINT_NIHON_LEAGUE
