...
MountMoonSquare_MapEvents:
	...
	db 3 ; warp events
	warp_event 20,  5, MOUNT_MOON, 4
	warp_event 22, 11, MOUNT_MOON, 5
	...
	db 3 ; object events
	object_event  6,  6, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MT_MOON_SQUARE_CLEFAIRY
	object_event  7,  6, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MT_MOON_SQUARE_CLEFAIRY
