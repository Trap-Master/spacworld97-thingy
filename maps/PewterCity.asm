...
PewterCity_MapEvents:
	...
	db 9 ; warp events
	warp_event 27, 11, PEWTER_NIDORAN_SPEECH_HOUSE, 1
	warp_event 14, 13, PEWTER_GYM, 1
	warp_event 23, 17, PEWTER_MART, 2
	warp_event 15, 25, PEWTER_POKECENTER_1F, 1
	warp_event  7, 29, PEWTER_SNOOZE_SPEECH_HOUSE, 1
	warp_event 18, 33, ROUTE_2, 8
	warp_event 19, 33, ROUTE_2, 8
	warp_event 35, 17, ROUTE_3, 2
	warp_event 35, 18, ROUTE_3, 2

	db 0 ; coord events

	db 7 ; bg events
	bg_event 25, 22, BGEVENT_READ, PewterCitySign
	bg_event 12, 13, BGEVENT_READ, PewterGymSign
	bg_event  9,  4, BGEVENT_READ, PewterMuseumSign
	bg_event 33, 17, BGEVENT_READ, PewterCityMtMoonGiftShopSign
	bg_event 13, 29, BGEVENT_READ, PewterCityWelcomeSign
	bg_event 16, 25, BGEVENT_READ, PewterCityPokecenterSign
	bg_event 24, 17, BGEVENT_READ, PewterCityMartSign

	db 5 ; object events
	object_event 20, 11, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PewterCityCooltrainerFScript, -1
	object_event 17, 28, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PewterCityBugCatcherScript, -1
