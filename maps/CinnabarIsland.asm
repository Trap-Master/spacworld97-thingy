...
CinnabarIsland_MapEvents:
	...
	db 4 ; bg events
	bg_event 34, 29, BGEVENT_READ, CinnabarIslandPokecenterSign
	bg_event 28, 26, BGEVENT_READ, CinnabarIslandGymSign
	bg_event 26, 25, BGEVENT_READ, CinnabarIslandSign
	bg_event 25, 23, BGEVENT_ITEM, CinnabarIslandHiddenRareCandy

	db 1 ; object events
	object_event 29, 27, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
