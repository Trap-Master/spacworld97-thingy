...
; level
	ld [wCurPartyLevel], a
	call GetNextTrainerDataByte ;added from 16
	push hl;added from 16
	push af;added from 16
	call GetNextTrainerDataByte;added from 16
	ld h, a;added from 16
	pop af;added from 16
	ld l, a;added from 16
; species 
	call GetPokemonIDFromIndex ; was ld a, [hli]
	ld [wCurPartySpecies], a

; add to party
	ld a, OTPARTYMON
	ld [wMonType], a
	;push hl is in the tutorial but not here.
