...
.PC_ElmsLab_OAM:
	dsprite   4, 0,   4, 2, $7c, PAL_OW_GREEN | OBP_NUM
	dsprite   4, 0,   4, 6, $7c, PAL_OW_GREEN | OBP_NUM
	dsprite   4, 6,   4, 0, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   4, 6,   5, 0, $7d, PAL_OW_GREEN | OBP_NUM | X_FLIP
	dsprite   5, 3,   4, 0, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   5, 3,   5, 0, $7d, PAL_OW_GREEN | OBP_NUM | X_FLIP
	dsprite   6, 0,   4, 0, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   6, 0,   5, 0, $7d, PAL_OW_GREEN | OBP_NUM | X_FLIP

.HealMachineGFX:
INCBIN "gfx/overworld/heal_machine.2bpp"

.HOF_OAM:
	dsprite   7, 4,  10, 1, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   7, 4,  10, 6, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   7, 3,   9, 5, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   7, 3,  11, 2, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   7, 1,   9, 1, $7d, PAL_OW_GREEN | OBP_NUM
	dsprite   7, 1,  11, 5, $7d, PAL_OW_GREEN | OBP_NUM
...
.cgb
	ld hl, .palettes
	ld de, wOBPals2 palette PAL_OW_GREEN
	ld bc, 1 palettes
	ld a, BANK(wOBPals2)
	call FarCopyWRAM
	ld a, $1
...
.go
	...
	ld hl, wOBPals2 palette PAL_OW_GREEN
	ld a, [hli]
	ld e, a
	ld a, [hli]
	ld d, a
